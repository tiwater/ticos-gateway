...
from ticos_gateway.connectors.modbus.constants import *
from ticos_gateway.connectors.modbus.slave import Slave
from ticos_gateway.connectors.modbus.backward_compability_adapter import BackwardCompatibilityAdapter
...
class ModbusConnector(Connector, Thread):
    ...
    def __init__(self, gateway, config, connector_type):
        ...
        if self.__config.get('slave'):
            ...
            if config['slave'].get('sendDataToTicos', False):
