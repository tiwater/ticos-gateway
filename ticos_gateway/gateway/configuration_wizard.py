...
if exists('ticos_gateway/config/ticos_gateway.yaml'):
    CONFIG_PATH = 'ticos_gateway/config/ticos_gateway.yaml'
elif exists(path.dirname(path.abspath(__file__)) + '/config/ticos_gateway.yaml'.replace('/', path.sep)):
    CONFIG_PATH = path.dirname(path.abspath(__file__)) + '/config/ticos_gateway.yaml'.replace('/', path.sep)
elif exists("/etc/ticos-gateway/config/ticos_gateway.yaml".replace('/', path.sep)):
    CONFIG_PATH = "/etc/ticos-gateway/config/ticos_gateway.yaml".replace('/', path.sep)
...
def configure():
    try:
        ...
        base_questions = [
            {
                ...
                'name': 'host',
                'message': 'Ticos host:',
                'default': default_config['ticos']['host'],
                ...
                },
            {
                ...
                'name': 'port',
                'message': 'Ticos port:',
                'default': str(default_config['ticos']['port']),
                ...
                },
            {
                ...
                'default': str(default_config['ticos']['statsSendPeriodInSeconds']),
                ...
                },
            {
                ...
                'default': str(default_config['ticos']['minPackSendDelayMS']),
                'validate': NumberValidator,
                'filter': lambda val: int(val)
                },
            {
                ...
                'default': str(default_config['ticos']['checkConnectorsConfigurationInSeconds']),
                'validate': NumberValidator,
                'filter': lambda val: int(val)
                },
            {
        ...
        f = Figlet(font='slant')
        print(colored(f.renderText('Ticos'), color='white'))
        print(colored(f.renderText('IoT Gateway'), color='red'))
        print(colored('Welcome to Ticos IoT Gateway configuration Wizard', 'cyan'))
        ...
        qos_and_storage_type_question = [
            {
                ...
                'message': 'QoS:',
                'validate': NumberValidator,
                'default': str(default_config['ticos']['qos']),
                'filter': lambda val: int(val)
                },
            {
                'type': 'list',
            ...
            storage_questions = [
                {
                    ...
                    'message': 'Count of messages to get from storage and send to Ticos:',
                    ...
                    },
                {
                    ...
                    'message': 'Maximum count of data in storage before send to Ticos:',
        ...
        generate_config_file(
            {
                'ticos': {**base_answers, 'security': security_answers,
