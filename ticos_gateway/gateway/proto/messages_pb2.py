...
_TicosGATEWAYPROTOSERVICE = _descriptor.ServiceDescriptor(
  name='TicosGatewayProtoService',
  full_name='messages.TicosGatewayProtoService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='stream',
    full_name='messages.TicosGatewayProtoService.stream',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_TicosGATEWAYPROTOSERVICE)

DESCRIPTOR.services_by_name['TicosGatewayProtoService'] = _TicosGATEWAYPROTOSERVICE
