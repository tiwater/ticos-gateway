...
from ticos_gateway.grpc_connectors.gw_grpc_client import GrpcClient
from ticos_gateway.grpc_connectors.gw_grpc_msg_creator import GrpcMsgCreator, Status
...
class GwGrpcConnector(Thread):
    ...
    def _incoming_messages_callback(self, data):
        ...
        if data.HasField("connectorConfigurationMsg"):
            ...
            log.info("Connector %s connected to Ticos IoT gateway", self.__connector_name)
