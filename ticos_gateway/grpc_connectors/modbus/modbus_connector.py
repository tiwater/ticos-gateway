...
from ticos_gateway.connectors.modbus.constants import TAG_PARAMETER, BYTE_ORDER_PARAMETER, WORD_ORDER_PARAMETER, \
    TYPE_PARAMETER, ADDRESS_PARAMETER, OBJECTS_COUNT_PARAMETER, PAYLOAD_PARAMETER, RPC_SECTION, UNIT_ID_PARAMETER, \
    LAST_PREFIX
from ticos_gateway.gateway.constants import DEVICE_NAME_PARAMETER, DEVICE_SECTION_PARAMETER, DATA_PARAMETER, \
...
class GrpcModbusConnector(GwGrpcConnector):
    ...
    def __init__(self, connector_config: str, config_dir_path: str):
        ...
        if self.__config.get('slave'):
            ...
            if self.__config['slave'].get('sendDataToTicos', False):
