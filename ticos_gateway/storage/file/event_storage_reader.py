...
from ticos_gateway.storage.file.event_storage_reader_pointer import EventStorageReaderPointer
from ticos_gateway.storage.file.file_event_storage import log
