...
class TicosUpdater(Thread):
    def __init__(self):
        ...
        try:
            self.__version = {"current_version": get_distribution('ticos_gateway').version,
                              "latest_version": get_distribution('ticos_gateway').version}
    ...
    def form_request_params(self):
        ...
        url = UPDATE_SERVICE_BASE_URL + "/api/ticos-gateway/updates"
        request_args = {
            "url": url,
            "json": json_data,
